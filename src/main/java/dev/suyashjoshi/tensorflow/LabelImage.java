/**
 * Class LabelImage demonstrates how to use pre-trained TensorFlow model 
 * for inference purpose in this case to classift certain types of animal images
 * 
 * This is a modification of the orignal demo forked from :
 * https://github.com/tensorflow/tensorflow/blob/master/tensorflow/java/src/main/java/org/tensorflow/examples/LabelImage.java
 *
 */

package dev.suyashjoshi.tensorflow;
...
public class LabelImage {
  private static void printUsage(PrintStream s) {
    final String url =
        "https://objectstorage.us-ashburn-1.oraclecloud.com/n/suyash/b/bucket-mlmodel/o/inception5h.zip";
    s.println(
        "Java program that uses a pre-trained Inception model (http://arxiv.org/abs/1512.00567)");
    s.println("to label JPEG images.");
    s.println("TensorFlow version: " + TensorFlow.version());
    s.println();
    s.println("Usage: label_image <path to ml model dir> <path to image file>");
    s.println();
    s.println("Where:");
